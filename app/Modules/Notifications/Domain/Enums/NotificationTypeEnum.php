...
enum NotificationTypeEnum: int
{
    ...
    public function kpiCategory(): NotificationKpiCategoryEnum
    {
        return match ($this) {
            ...
            self::PhoneUpdated,
            self::NewMessage        => NotificationKpiCategoryEnum::Shipments,
            self::ApprovalRequest,
            self::TimerStart,
            self::TimerExpired      => NotificationKpiCategoryEnum::Approvals,
            self::Collected         => NotificationKpiCategoryEnum::Collections,
            self::Settled           => NotificationKpiCategoryEnum::Settlements,
            self::Returned,
