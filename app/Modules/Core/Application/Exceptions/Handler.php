...
class Handler extends ExceptionHandler
{
    ...
    public function handleApiException($request, Throwable $e)
    {
        ...
        if ($e instanceof UnauthorizedHttpException) {
            return ApiResponse::error(
                $e->getMessage() ?: __('core::messages.token_not_provided'),
                null,
                401
            );
        }
        ...
        if ($e instanceof ModelNotFoundException) {
            return ApiResponse::error(
                __('core::messages.resource_not_found'),
                null,
                404
            );
        }
        ...
        if ($e instanceof NotFoundHttpException) {
            return ApiResponse::error(
                __('core::messages.page_not_found'),
                ['detail' => __('core::messages.page_unavailable')],
                404
            );
        }
        ...
        if ($e instanceof MethodNotAllowedHttpException) {
            return ApiResponse::error(
                __('core::messages.method_not_allowed'),
                null,
                405
            );
        }
        ...
        return ApiResponse::error(
            __('core::messages.something_went_wrong'),
            null,
            500
        );
    }
