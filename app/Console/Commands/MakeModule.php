...
class MakeModule extends Command
{
    ...
    public function handle(): void
    {
        ...
        $this->createLangFiles($name, $basePath);
    ...
    private function createModuleFile(string $name, string $basePath): void
    {
     ...
     private function createLangFiles(string $name, string $basePath): void
    {
        $locales = ['en', 'ar'];
        ...
        foreach ($locales as $locale) {
            $langPath = "{$basePath}/Presentation/Resources/Lang/{$locale}";

            File::put("{$langPath}/messages.php", $messagesContent);
            File::put("{$langPath}/validation.php", $validationContent);
        }
    }
